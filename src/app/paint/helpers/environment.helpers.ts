const OS_VERSTION_USER_AGENTS: { osName: string; userAgentRegex: RegExp }[] = [
  {osName: 'Windows 11',userAgentRegex:/(Windows 11.0 | Windows NT 11.0)/},
...
export function getOsVersion(): string {
  return OS_VERSTION_USER_AGENTS.find((x) => x.userAgentRegex.test(window.navigator.userAgent))?.osName as string;
}

...
export abstract class DrawingToolAction extends TsPaintAction {
  constructor(public points: Point[], public swapColors: boolean, public override renderIn: 'image' | 'preview' | 'nowhere') {
    super(renderIn);
    this._deselectsSelection = true;
  }

  protected abstract draw(points: Point[], color1: Color, color2: Color, image: ImageData, state: TsPaintStoreState):any;
